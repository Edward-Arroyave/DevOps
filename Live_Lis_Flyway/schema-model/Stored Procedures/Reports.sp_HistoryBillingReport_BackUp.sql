...
*/
-- =============================================
CREATE PROCEDURE [Reports].[sp_HistoryBillingReport_BackUp]
(
	@InitialDate date = '',
	@FinalDate date = '',
...
BEGIN
	...
	SELECT	I.NIT, YEAR(G.ElectronicBillingDate) ANO, MONTH(G.ElectronicBillingDate) MES, DAY(G.ElectronicBillingDate) DIA, 
		...
		--	D.CUPS CUPS, 
			...
			G.InvoiceNumber NumeroFactura, B.Value Valor, B.Hiring, CASE WHEN B.IdGenerateCopay_CM = 2 THEN E.TotalValuePatient ELSE 0 END Copago,
